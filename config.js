...
const CONFIG = {
  ...
  // ---------- MODELO DE KURAMOTO ----------
  kuramoto: {
    K: 2.0,                  // fuerza de acoplamiento global BASE — más alto frente al rango de ω, para que el desfase se apriete y se sienta "sincronizado"
    singerWeightMult: 2.5,   // cuánto más pesa el valor de la cantante θ_j cuando aparece en la ecuación de OTROS
    distanceFalloff: 500,    // px (en el canvas ya escalado). 1500 era casi uniforme (sin efecto real de cercanía); esto sí da preferencia a vecinas.
  ...
  // Colliders calibrados a mano en modo D + arrastre.
  skulls: [
